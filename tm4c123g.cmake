...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mthumb ${CPU} ${FPU} -std=c++17 -Os -ffunction-sections -fdata-sections -MD -Wall -pedantic -fno-exceptions -fno-rtti")
...
add_definitions(-D TARGET_IS_TM4C123_RA1)
add_definitions(-D gcc)
